...
#     {:ok, tag_group} = Repos.create_tag_group(@create_attrs)
#     tag_group
#   end
...
#     test "renders tag_group when data is valid", %{
#       conn: conn,
#       tag_group: %TagGroup{id: id} = tag_group
#     } do
...
#       assert json_response(conn, 200)["data"] == %{"id" => id, "tags" => []}
#     end
